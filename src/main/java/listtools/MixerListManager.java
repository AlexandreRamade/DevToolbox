...
public class MixerListManager {
     ...
     * listA = A1, A2, A3, A4
     * listB = B1, B2, B3, B4
     * alternateItems() => A1, B1, A2, B2, A3, B3, A4, B4
     * </p>
     */
     ...
     * </p>
     * <p>Exemple :
     * listA = A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12, A13, A14
     * listB = B1, B2, B3, B4, B5, B6, B7, B8, B9
     * alternateItemsEvery(2, 3) => A1, A2, B1, B2, B3, A3, A4, B4, B5, B6, A5, A6, B7, B8, B9, A7, A8, A9, A10, A11, A12, A13, A14
     * </p>
     *
     * @param n nombre d'éléments de la liste A
     ...
     * <p>
     *     remplace un élément de la liste A par les éléments de la liste B tous les n éléments
     * </p>
     * <p>Exemple :
     ...
     * <p>
     *     remplace un groupe d'élément de la liste A par un groupe d'éléments de la liste B
     * </p>
     * <p>Exemple :
     *     listA = A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12
     *     listB = B1, B2, B3, B4, B5, B6
     *     replaceGroupItemsEvery(2, 3) => A1, A2, B1, B2, B3, A6, A7, B4, B5, B6, A11, A12
     * </p>
     *
     * @param n nombre d'éléments de la liste A
     ...
     * mixLists </br>
     * <p>
     *     mixe les 2 listes en alternant et remplaçant un élément sur deux de chaque liste
     * </p>
     * <p>Exemple :
     *     listA = A1, A2, A3, A4, A5, A6
     *     listB = B1, B2, B3, B4, B5, B6
     ...
     * mixListsEvery </br>
     * <p>
     *     parcours les 2 listes en remplacent un élément de la liste A par un élément de la liste B tous les n éléments de la liste A
     * </p>
     * <p>Exemple :
     *      listA = A1, A2, A3, A4, A5, A6
     *      listB = B1, B2, B3, B4, B5, B6
     ...
     * <p>
     *     parcours les 2 listes en remplacent un groupe d'éléments de la liste A par un groupe d'éléments de la liste B
     * </p>
     * <p>Exemple :
     *     listA = A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12
     *     listB = B1, B2, B3, B4, B5, B6, B7, B8, B9, B10, B11, B12
     *     mixListsByGroupEvery(2, 3) => A1, A2, B3, B4, B5, A6, A7, B8, B9, B10, A11, A12
     * </p>
     * @param n nombre d'éléments de la liste A
     * @param group nombre d'éléments de la liste B
     */
     ...
     * alternateItemsIf </br>
     * <p>
     *     insere les éléments de la liste B dans la liste A uniquement s'ils vérifient la condition passée en paramètre
     * </p>
     * <p>Exemple :
     *     listA = A1, A2, A3, A4, A5, A6
     *     listB = B1, B2, B3, B4, B5, B6
     *     alternateItemsIf(stringContainEvenNumber) => A1, A2, B2, A3, A4, B4, A5, A6, B6
     * </p>
     *
     ...
     * replaceItemsIf </br>
     * <p>
     *     remplace les éléments de la liste A par les élements de la liste B uniquement s'ils vérifient la condition passée en paramètre
     * </p>
     * <p>Exemple :
     *     listA = A1, A2, A3, A4, A5, A6
     *     listB = B1, B2, B3, B4, B5, B6
     ...
     * mixListsIf </br>
     * <p>
     *     parcours les listes A et B et ne conserve que les éléments vérifiant la condition passée en paramètre
     * </p>
     * <p>Exemple :
     *     listA = A1, A2, A3, A4, A5, A6
     *     listB = B1, B2, B3, B4, B5, B6
     ...
     * </p>
     *
     * @param predicate condition que doivent vérifier les éléments de la liste A et B
     */
     ...
     * mixListsIf </br>
     * <p>
     *     parcours les listes A et B et ne conserve que les éléments vérifiant les conditions passées en paramètre
     * </p>
     * <p>Exemple :
     *     listA = A1, A2, A3, A4, A5, A6
     *     listB = B1, B2, B3, B4, B5, B6
     *     mixListsIf(stringContainEvenNumber, stringContainOddEvenNumber) => B1, A2, B3, A4, B5, A6
     * </p>
     *
     * @param predicateListA condition que doivent vérifier les éléments de la liste A
     * @param predicateListB condition que doivent vérifier les éléments de la liste B
     */
     ...
     * alternateOrReplaceGroupItemsEvery </br>
     * <p>
     * méthode permétant d'alterner ou de remplacer un groupe d'élément de la liste A par un groupe d'élément de la liste B de manière consécutives
     * </p>
     * <p>Exemples d'utilisation :</br>
     * listA = A1, A2, A3, A4, A5, A6, A7, A8, A9, A10, A11, A12, A13, A14
     * listB = B1, B2, B3, B4, B5, B6, B7, B8, B9
     *  -> alterner
     * alternateOrReplaceGroupItemsEvery(2, 3, false, false) => A1, A2, B1, B2, B3, A3, A4, B4, B5, B6, A5, A6, B7, B8, B9, A7, A8, A9, A10, A11, A12, A13, A14
     *  -> remplacer
     * alternateOrReplaceGroupItemsEvery(2, 3, true, false) => A1, A2, B1, B2, B3, A6, A7, B4, B5, B6, A11, A12, B7, B8, B9
     *  -> mixer
     * alternateOrReplaceGroupItemsEvery(2, 3, false, true) => A1, A2, B3, B4, B5, A6, A7, B8, B9, A10, A11, A12, A13, A14
     * </p>
     *
     * @param n nombre d'elements par groupe de la liste A
     * @param group nombre d'éléments par groupe de la liste B
     * @param replaceItemsFromListA true = éléments de la liste A remplacés par les éléments de la liste B / false = insertion des éléments B dans la liste A
     * @param mixLists pour un index donné seuls l'élément de l'une des 2 liste est conservé
     */
    private void alternateOrReplaceGroupItemsEvery(int n, int group, boolean replaceItemsFromListA, boolean mixLists) {
        this.mixedList.clear();
        n++; // permet que le nb passé en param corresponde au nb d'elts de la liste A (cohérence avec group = nb d'elts de la liste B)

        // alterne les éléments des listes A et B jusqu'à ce que l'une des listes soit entièrement consomée
        int a = 0, b = 0;
     ...
     * Si la condition est vérifiée, l'élément de la liste B est conservé et est inséré après ou remplace celui de la liste A du même index.</br>
     * Sinon, c'est l'élément de la liste A qui est conservé.
     * </p>
     *
     * @param predicate test spécifique aux éléments de la liste B
     * @param replaceItemsFromListA true = éléments A remplacé par élément B si test vérifié / false = élément B inséré après l'élément A du même index
     */
     ...
     * <p>
     * Ne conserve que les éléments des listes A et B qui vérifient le test spécifique à chaque liste passé en paramètre.</br>
