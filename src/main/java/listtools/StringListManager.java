...
public class StringListManager {
    ...
    private String LISTE_REF = "id;sessionNumber;postType;date;platforms;pics;vids;fan;price;paymentPlatform;tip;viaGoogleDrive;hashtags;comment\n" +
            "1;1001;PUBLIC;03/02/22;MYM|Twitter|Instagram;true;false;;;;;;#bondage|#hogtie|#rope|#chair|#ballgag|#nippleclamps|#puffyjacket|#boots|#mymfan;Great news! I opened a MYM account. You can see my first vid tomorrow on mym.fans/Olivertheselfslave<{I will post a new video every week\n" +
            "2;1001;PUBLIC;03/02/22;MYM;false;true;;;;;;#bondage|#hogtie|#rope|#chair|#ballgag|#nippleclamps|#puffyjacket|#boots|#mymfan;I am a shy guy. So for my first date, I asked my dom not to be naked<{I didn't expect to keep my puffy jacket on during the whole time\n" +
            "3;1001;PUBLIC;03/02/22;Twitter|Instagram;false;true;;;;;;#bondage|#hogtie|#rope|#chair|#ballgag|#nippleclamps|#puffyjacket|#boots|#mymfan;My first video available on mym.fans/Olivertheselfslave<{Isn't it daring to start an erotic channel wearing  a puffy jacket<{Music: Destabilized by Punch Deck\n" +
            "4;1001;PUBLIC;03/02/22;MYM|Twitter|Instagram;true;false;;;;;;#bondage|#hogtie|#rope|#chair|#ballgag|#nippleclamps|#puffyjacket|#boots|#mymfan; \n" +
            "5;104;PUBLIC;08/02/22;MYM|Twitter|Instagram;true;false;;;;;;#bondage|#selfbondage|#ballgagged|#nike|#sneakers|#airmax;An old misadventure.<{I thought I was home alone. A stranger surprised me. He threatened me, handcuffed and gagged me. Then he tied some straps to my ankles.<{I didn't know what he would do to me next...\n" +
            "10;AAH;PRIVATE;25/02/22;MYM;true;false;1;0;;0;false;; \n" +
            "11;AAI;PRIVATE;26/03/22;Twitter;false;true;2;50;PayPal;0;true;; ";
